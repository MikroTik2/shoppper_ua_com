     ...
     */
     ...
     this.cnb_form = function cnb_form(params) {
          ...
          return    '<form method="POST" action="https://www.liqpay.ua/api/3/checkout" accept-charset="utf-8">' +
                         ...
                         '<input style="width: 230px; cursor: pointer; border: none; font-size: 16px; height: 50px; display: flex; align-items: center; justify-content: center; background: #000000; color: #ffffff; border-radius: 50px;" type="submit"/>' +
                    '</form>';
     };
